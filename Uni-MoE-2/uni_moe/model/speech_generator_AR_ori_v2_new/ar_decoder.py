...
class LLM2TTSCodecAR(torch.nn.Module):
    ...
    def __init__(self, args):
        ...
        # print(self.vocab_size, args.llm_vocab_size,args.transformer_attention_dim,args.transformer_linear_units,args.transformer_num_blocks,args.transformer_attention_heads,args.transformer_kv_heads,args.transformer_dropout_rate,config.num_hidden_layers,config.hidden_size,config.rms_norm_eps,args.encoder_output_dim)
        self.qwenvl_embed_tokens = nn.Embedding(151936, 2048, None)
