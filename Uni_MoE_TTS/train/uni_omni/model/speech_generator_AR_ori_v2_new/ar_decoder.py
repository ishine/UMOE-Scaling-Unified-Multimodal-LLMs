...
class LLM2TTSCodecAR(torch.nn.Module):
    ...
    def __init__(self, args):
        ...
        print("warning!!!!!! initializing original AR V2 new model for training!!!!!")
        self.idim = args.idim
        self.odim = args.odim
        ...
        print(args.idim,args.odim,args.encoder_pre_norm_type,args.encoder_drop_rate,args.encoder_criterion,args.encoder_upsample_rate)
        print(args.llm_vocab_size,args.transformer_attention_dim,args.transformer_linear_units,args.transformer_num_blocks,args.transformer_attention_heads,args.transformer_kv_heads,args.transformer_dropout_rate,config.num_hidden_layers,config.hidden_size,config.rms_norm_eps,args.encoder_output_dim)
        qwenconfig = AutoConfig.from_pretrained("/HOME/hitsz_hubaotian/hitsz_hubaotian_1/HDD_POOL/Model/Qwen2.5-VL-3B-Instruct")#args.qwenconfig
    ...
    def forward(self, batch):
        ...
        # print(encoder_inputs_embeds.shape,llm_hidden.shape,x_emb.shape)
