...
If you want to infer with python command, follow the examples in `/inference/infer.sh`, please change the `path/to/Uni_MoE_TTS` and `path/to/Uni-MoE-TTS-CKPT` in the script to the path of your downloaded code and model.
